export const metadata = {
  ...
  alternates: {
    canonical: '/thought/load-testing',
  },
};
...
- **Authorization Server** — Issues tokens and handles authentication.
- **Resource Owner** — The user being authenticated.
- **Identity Token** — Contains user details.
- **Access Token** — Used to access protected APIs.

---

## Setting Up JMeter for OIDC Authentication 🚀

JMeter allows simulation of multiple user logins to test authentication under load. Here’s a step-by-step approach.
...
- [OpenID Connect — How to Load Test with JMeter](https://www.blazemeter.com/blog/openid-connect-jmeter)
...
Listening to music while working? Check out _"Experience"_ by Ludovice Einaudi - it’s perfect for concentration and mindfulness.